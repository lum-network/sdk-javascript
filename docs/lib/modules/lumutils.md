...
- [generateAuthInfo](lumutils.md#generateauthinfo)
...
▸ `Const`**generateAuthInfo**(`publicKey`: *Uint8Array*, `fee`: [*Fee*](../interfaces/lumtypes.fee.md), `sequence`: *number*): *Uint8Array*
...
▸ `Const`**generateSignDoc**(`messages`: [*Message*](../interfaces/lummessages.message.md)[], `memo`: *undefined* \| *string*, `authInfoBytes`: *Uint8Array*, `chainId`: *string*, `accountNumber`: *number*): [*SignDoc*](../interfaces/lumtypes.signdoc.md)
...
Name | Type | Description |
:------ | :------ | :------ |
`messages` | [*Message*](../interfaces/lummessages.message.md)[] | Transaction messages   |
`memo` | *undefined* \| *string* | optional memo for the transaction   |
`authInfoBytes` | *Uint8Array* | info bytes (as generated by the generateAuthInfo function)   |
