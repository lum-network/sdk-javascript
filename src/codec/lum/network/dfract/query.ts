...
export const QueryModuleAccountBalanceResponse = {
    ...
    toJSON(message: QueryModuleAccountBalanceResponse): unknown {
        const obj: any = {};
        if (message.moduleAccountBalance?.length) {
            obj.moduleAccountBalance = message.moduleAccountBalance.map((e) => Coin.toJSON(e));
        }
        return obj;
    },
...
export const QueryFetchDepositsRequest = {
    ...
    toJSON(message: QueryFetchDepositsRequest): unknown {
        ...
        if (message.type !== 0) {
            obj.type = depositsQueryTypeToJSON(message.type);
        }
        return obj;
    },
...
export const QueryGetDepositsForAddressResponse = {
    ...
    toJSON(message: QueryGetDepositsForAddressResponse): unknown {
        const obj: any = {};
        if (message.depositsPendingWithdrawal !== undefined) {
            obj.depositsPendingWithdrawal = Deposit.toJSON(message.depositsPendingWithdrawal);
        }
        if (message.depositsPendingMint !== undefined) {
            obj.depositsPendingMint = Deposit.toJSON(message.depositsPendingMint);
        }
        if (message.depositsMinted !== undefined) {
            obj.depositsMinted = Deposit.toJSON(message.depositsMinted);
        }
        return obj;
    },
...
export const QueryServiceName = 'lum.network.dfract.Query';
