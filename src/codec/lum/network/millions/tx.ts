...
export const MsgUpdateParams = {
    ...
    toJSON(message: MsgUpdateParams): unknown {
        ...
        if (message.maxPrizeStrategyBatches !== '') {
            obj.maxPrizeStrategyBatches = message.maxPrizeStrategyBatches;
        }
        if (message.maxPrizeBatchQuantity !== '') {
            obj.maxPrizeBatchQuantity = message.maxPrizeBatchQuantity;
        }
        if (message.minDrawScheduleDelta !== undefined) {
...
export const MsgRegisterPool = {
    ...
    toJSON(message: MsgRegisterPool): unknown {
        ...
        if (message.drawSchedule !== undefined) {
            obj.drawSchedule = DrawSchedule.toJSON(message.drawSchedule);
        }
        if (message.prizeStrategy !== undefined) {
            obj.prizeStrategy = PrizeStrategy.toJSON(message.prizeStrategy);
        }
        if (message.bech32PrefixAccAddr !== '') {
            obj.bech32PrefixAccAddr = message.bech32PrefixAccAddr;
        }
        if (message.bech32PrefixValAddr !== '') {
            obj.bech32PrefixValAddr = message.bech32PrefixValAddr;
        }
        if (message.creatorAddress !== '') {
...
function createBaseMsgDepositEdit(): MsgDepositEdit {
    return { poolId: Long.UZERO, depositId: Long.UZERO, winnerAddress: '', isSponsor: undefined, depositorAddress: '' };
}
...
export const MsgDepositEdit = {
    encode(message: MsgDepositEdit, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.isSponsor !== undefined) {
            BoolValue.encode({ value: message.isSponsor! }, writer.uint32(34).fork()).ldelim();
        }
        if (message.depositorAddress !== '') {
    ...
    fromJSON(object: any): MsgDepositEdit {
        return {
            poolId: isSet(object.poolId) ? Long.fromValue(object.poolId) : Long.UZERO,
            depositId: isSet(object.depositId) ? Long.fromValue(object.depositId) : Long.UZERO,
            winnerAddress: isSet(object.winnerAddress) ? String(object.winnerAddress) : '',
    ...
    toJSON(message: MsgDepositEdit): unknown {
        const obj: any = {};
        if (!message.poolId.isZero()) {
            obj.poolId = (message.poolId || Long.UZERO).toString();
        }
    ...
    create<I extends Exact<DeepPartial<MsgDepositEdit>, I>>(base?: I): MsgDepositEdit {
        return MsgDepositEdit.fromPartial(base ?? {});
    },

    fromPartial<I extends Exact<DeepPartial<MsgDepositEdit>, I>>(object: I): MsgDepositEdit {
        const message = createBaseMsgDepositEdit();
        message.poolId = object.poolId !== undefined && object.poolId !== null ? Long.fromValue(object.poolId) : Long.UZERO;
        message.depositId = object.depositId !== undefined && object.depositId !== null ? Long.fromValue(object.depositId) : Long.UZERO;
        message.winnerAddress = object.winnerAddress ?? '';
...
export const MsgDepositEditResponse = {
    ...
    fromJSON(_: any): MsgDepositEditResponse {
        return {};
    },

    toJSON(_: MsgDepositEditResponse): unknown {
        const obj: any = {};
        return obj;
    },

    create<I extends Exact<DeepPartial<MsgDepositEditResponse>, I>>(base?: I): MsgDepositEditResponse {
        return MsgDepositEditResponse.fromPartial(base ?? {});
    },

    fromPartial<I extends Exact<DeepPartial<MsgDepositEditResponse>, I>>(_: I): MsgDepositEditResponse {
        const message = createBaseMsgDepositEditResponse();
        return message;
    },
};
...
export const MsgClaimPrize = {
    ...
    toJSON(message: MsgClaimPrize): unknown {
        ...
        if (!message.prizeId.isZero()) {
            obj.prizeId = (message.prizeId || Long.UZERO).toString();
        }
        if (message.winnerAddress !== '') {
            obj.winnerAddress = message.winnerAddress;
        }
...
export const MsgDrawRetry = {
    ...
    toJSON(message: MsgDrawRetry): unknown {
        ...
        if (message.drawRetryAddress !== '') {
            obj.drawRetryAddress = message.drawRetryAddress;
        }
        return obj;
    },
...
export const MsgRestoreInterchainAccounts = {
    ...
    toJSON(message: MsgRestoreInterchainAccounts): unknown {
        ...
        if (message.restorerAddress !== '') {
            obj.restorerAddress = message.restorerAddress;
        }
        return obj;
    },
...
export const MsgServiceName = 'lum.network.millions.Msg';
export class MsgClientImpl implements Msg {
    ...
    DepositEdit(request: MsgDepositEdit): Promise<MsgDepositEditResponse> {
        ...
        const promise = this.rpc.request(this.service, 'DepositEdit', data);
        return promise.then((data) => MsgDepositEditResponse.decode(_m0.Reader.create(data)));
    }
