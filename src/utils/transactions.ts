...
import { Fee, Doc, SignMsg, DocSigner } from '../types';
import { LumRegistry } from '../registry';
import { sortJSON } from './commons';
import { sha256, toAscii, fromBech32 } from './encoding';
 ...
 */
export const generateSignDoc = (doc: Doc, signerIdx: number, signMode: SignMode): LumTypes.SignDoc => {
 ...
 */
export const generateSignDocBytes = (signDoc: LumTypes.SignDoc): Uint8Array => {
 ...
 */
export const generateTxBytes = (signDoc: LumTypes.SignDoc, signatures: Uint8Array[]) => {
