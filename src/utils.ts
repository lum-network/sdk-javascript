...
export const getAddressFromPublicKey = (publicKey: Uint8Array, prefix = constants.LumAddressPrefix) => {
...
export const isAddressValid = (address: string, prefix: string | undefined = constants.LumAddressPrefix): boolean => {
    try {
